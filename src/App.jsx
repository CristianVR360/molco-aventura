...
function App() {
  ...
  return (
    <div className="min-h-screen bg-[#f4f7f5] text-[#1b2a22] font-sans antialiased selection:bg-emerald-600 selection:text-white">
      {/* Header / Navigation */}
      <header className="sticky top-0 z-50 bg-white/95 backdrop-blur-md border-b border-emerald-100 transition-all shadow-sm">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-20 flex justify-between items-center">
          <div className="flex items-center gap-3">
            ...
            />
            <span className="font-display font-extrabold text-xl tracking-wider text-emerald-800 hidden sm:inline">
              MOLCO<span className="text-[#ea580c]">AVENTURA</span>
            </span>
          </div>
          <nav className="hidden md:flex items-center gap-8">
            <a href="#inicio" className="font-display font-bold text-sm text-emerald-800 hover:text-emerald-500 transition">Inicio</a>
            <a href="#conocenos" className="font-display font-bold text-sm text-emerald-800 hover:text-emerald-500 transition">Conócenos</a>
            <a href="#servicios" className="font-display font-bold text-sm text-emerald-800 hover:text-emerald-500 transition">Servicios</a>
            <a href="#itinerario" className="font-display font-bold text-sm text-emerald-800 hover:text-emerald-500 transition">Itinerario</a>
            <a href="#tarifas" className="font-display font-bold text-sm text-emerald-800 hover:text-emerald-500 transition">Tarifas</a>
            <a 
              href="https://wa.me/56986128398" 
              target="_blank" 
              rel="noopener noreferrer" 
              className="font-display font-bold text-sm border-2 border-emerald-600 text-emerald-600 hover:bg-emerald-600 hover:text-white px-5 py-2 rounded-full transition shadow-sm"
            >
              Contacto
            </a>
          </nav>
      ...
      <section 
        ...
        style={{ 
          backgroundImage: `linear-gradient(to bottom, rgba(244, 247, 245, 0.75), rgba(244, 247, 245, 0.98)), url('https://images.unsplash.com/photo-1470071459604-3b5ec3a7fe05?q=80&w=1920&auto=format&fit=crop')` 
        }}
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full relative z-10">
          <div className="max-w-2xl">
            <span className="text-emerald-600 uppercase font-display font-extrabold text-sm tracking-widest block mb-3 bg-emerald-100/80 px-3 py-1 rounded-md max-w-max">
              🏔️ Araucanía & Los Ríos
            </span>
            <h1 className="text-5xl sm:text-7xl font-display font-extrabold tracking-tight mb-4 text-emerald-950">
              MOLCO AVENTURA
            </h1>
            <div className="text-2xl sm:text-3xl font-display font-extrabold text-[#ea580c] mb-6">
              Región de la Araucanía – Región de los Ríos
            </div>
            <p className="text-[#2b3a32] text-lg font-medium mb-8 leading-relaxed">
            ...
            <div className="flex flex-wrap gap-4">
              <a 
                ...
                target="_blank" 
                rel="noopener noreferrer" 
                className="inline-flex items-center justify-center bg-[#ea580c] text-white font-display font-extrabold px-8 py-4 rounded-full shadow-lg shadow-orange-600/30 hover:bg-orange-600 hover:scale-[1.02] transition"
              >
              ...
              <a 
                href="#itinerario" 
                className="inline-flex items-center justify-center border-2 border-cyan-600 text-cyan-700 bg-cyan-50/50 font-display font-bold px-8 py-4 rounded-full hover:bg-cyan-600 hover:text-white transition shadow-sm"
              >
                Ver Itinerarios
              </a>
            </div>
      ...
      <section id="conocenos" className="py-24 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <span className="text-emerald-600 uppercase font-display font-extrabold text-sm tracking-widest block mb-2">
            Nuestra Esencia
          </span>
          <h2 className="text-3xl sm:text-5xl font-display font-bold text-emerald-950">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          <div className="lg:col-span-7 flex flex-col gap-6 text-lg">
            <p className="text-emerald-900 font-semibold border-l-4 border-emerald-500 pl-4 py-2 italic bg-emerald-50 rounded-r leading-relaxed">
            ...
            <div className="bg-white p-8 rounded-2xl border border-emerald-100 shadow-md">
              <h3 className="text-xl font-display font-bold text-emerald-700 mb-3">Ubicación Estratégica</h3>
          ...
          <div className="lg:col-span-5 flex flex-col gap-6">
            <div className="bg-white p-6 rounded-xl border border-emerald-100 shadow-sm">
              <h4 className="font-display font-bold text-emerald-900 mb-3">Ciudades que Visitaremos</h4>
              <div className="flex flex-wrap gap-2">
                {['Villarrica', 'Pucón', 'Panguipulli', 'Valdivia'].map((city) => (
                  <span key={city} className="bg-emerald-50 text-emerald-800 border border-emerald-200/50 px-3.5 py-1.5 rounded-full text-sm font-bold">{city}</span>
                ))}
              </div>
            </div>

            <div className="bg-white p-6 rounded-xl border border-cyan-100 shadow-sm">
              <h4 className="font-display font-bold text-cyan-900 mb-3">Atractivos Naturales (Lagos & Ríos)</h4>
              <div className="flex flex-wrap gap-2">
                {[
                  'Lago Villarrica', 'Lago Caburgua', 'Reserva Biológica Huilo Huilo',
                  'Puerto Fuy', 'Puerto Pirehueico', 'Niebla', 'Río Valdivia'
                ].map((attract) => (
                  <span key={attract} className="bg-cyan-50/70 text-cyan-800 border border-cyan-200/50 px-3.5 py-1.5 rounded-full text-sm font-semibold">{attract}</span>
                ))}
              </div>
            </div>
          </div>
        ...
        <div className="bg-white rounded-3xl p-8 border border-emerald-100 shadow-lg mt-12 grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
          <div>
            <h3 className="text-2xl font-display font-bold text-emerald-950 mb-4">Ruta Geográfica de Aventura</h3>
            <p className="text-slate-700 leading-relaxed">
          ...
          <div className="bg-cyan-50/50 border border-cyan-100 rounded-2xl p-4 flex items-center justify-center min-h-[250px]">
            <svg className="w-full h-full max-w-[400px]" viewBox="0 0 400 200">
              <path d="M 50,150 Q 150,50 250,160 T 350,80" fill="none" stroke="rgba(6, 182, 212, 0.1)" strokeWidth="6" strokeDasharray="10 5" />
              <path d="M 50,150 Q 150,50 250,160 T 350,80" fill="none" stroke="#06b6d4" strokeWidth="3" />
              
              <circle cx="50" cy="150" r="8" fill="#ea580c" />
              <text x="50" y="130" fill="#1b2a22" fontSize="11" textAnchor="middle" className="font-bold">Valdivia</text>
              
              <circle cx="150" cy="85" r="8" fill="#0284c7" />
              <text x="150" y="65" fill="#1b2a22" fontSize="11" textAnchor="middle" className="font-bold">Panguipulli</text>
              
              <circle cx="260" cy="155" r="8" fill="#0284c7" />
              <text x="260" y="180" fill="#1b2a22" fontSize="11" textAnchor="middle" className="font-bold">Huilo Huilo</text>

              <circle cx="340" cy="85" r="9" fill="#ea580c" />
              <text x="340" y="65" fill="#1b2a22" fontSize="11" textAnchor="middle" className="font-bold">Base (Villarrica/Pucón)</text>
            </svg>
          </div>
        </div>
        ...
        {/* Galería dinámica */}
        <div className="mt-16">
          <h3 className="text-xl font-display font-bold text-emerald-950 mb-6">Galería de Experiencias (Fotos y Videos)</h3>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {[
              ...
              <div key={i} className="group relative rounded-xl overflow-hidden aspect-[4/3] cursor-pointer shadow-md hover:shadow-xl transition">
                ...
                />
                <div className="absolute inset-0 bg-gradient-to-t from-[#1b2a22]/85 via-transparent to-transparent flex items-end p-4">
      ...
      {/* Servicios Section */}
      <section id="servicios" className="py-24 bg-emerald-50/60 border-y border-emerald-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
            {[
              { title: 'Camping, Refugio o Cabaña', desc: 'Diversas opciones de descanso en Camping Aldea Molco rodeado de verdes bosques nativos.', icon: '⛺', accent: 'border-emerald-200 text-emerald-700 bg-emerald-50' },
              { title: 'Tours Guiados Incluidos', desc: 'Viajes organizados full day a los principales centros de atracción fluvial y cordillerana.', icon: '🗺️', accent: 'border-cyan-200 text-cyan-700 bg-cyan-50' },
              { title: 'Deportes Náuticos', desc: 'Navegación veloz y recreativa en lancha, SUP y arrastrables sobre el Lago Villarrica.', icon: '🚤', accent: 'border-sky-200 text-sky-700 bg-sky-50' }
            ].map((p, i) => (
              <div key={i} className={`bg-white p-8 rounded-2xl border ${p.accent} hover:shadow-xl hover:-translate-y-1 transition duration-300 text-center`}>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 rounded-3xl overflow-hidden border border-emerald-100 bg-white shadow-xl">
            <div 
            ...
            <div className="p-8 sm:p-12 flex flex-col justify-center bg-white">
              <h3 className="text-2xl sm:text-3xl font-display font-bold text-emerald-700 mb-6">
              ...
              <p className="text-slate-700 leading-relaxed border-t border-emerald-100 pt-4 font-medium italic">
      ...
      <section id="itinerario" className="py-24 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <span className="text-cyan-600 uppercase font-display font-extrabold text-sm tracking-widest block mb-2">
            Cronograma del Tour
          </span>
        ...
        <div className="bg-white rounded-3xl p-6 sm:p-10 border border-emerald-100 shadow-xl">
          {/* Tabs Navigation */}
          <div className="flex flex-wrap justify-center gap-2 mb-10 bg-slate-100 p-1.5 rounded-full max-w-max mx-auto border border-slate-200">
            <button 
              onClick={() => setActiveTab('dia2')} 
              className={`px-6 py-2.5 rounded-full font-display font-bold text-sm transition ${activeTab === 'dia2' ? 'bg-emerald-600 text-white shadow-sm' : 'text-emerald-800 hover:text-emerald-600'}`}
            >
              2do Día: Valdivia
            </button>
            <button 
              onClick={() => setActiveTab('dia4')} 
              className={`px-6 py-2.5 rounded-full font-display font-bold text-sm transition ${activeTab === 'dia4' ? 'bg-emerald-600 text-white shadow-sm' : 'text-emerald-800 hover:text-emerald-600'}`}
            >
              4to Día: Panguipulli - Pto. Fuy
            </button>
            <button 
              onClick={() => setActiveTab('dia5')} 
              className={`px-6 py-2.5 rounded-full font-display font-bold text-sm transition ${activeTab === 'dia5' ? 'bg-emerald-600 text-white shadow-sm' : 'text-emerald-800 hover:text-emerald-600'}`}
            >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
            <div className="lg:col-span-7">
              <h3 className="text-2xl sm:text-3xl font-display font-bold text-emerald-950 mb-2">
              ...
              <div className="space-y-4">
                {itineraryData[activeTab].highlights.map((hl) => (
                  <div key={hl.num} className="flex gap-4 items-start">
                    ...
                    <div>
                      <h4 className="font-display font-bold text-emerald-900">{hl.title}</h4>
      ...
      <section id="tarifas" className="py-24 bg-cyan-50/30 border-t border-cyan-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <span className="text-emerald-600 uppercase font-display font-extrabold text-sm tracking-widest block mb-2">
              Elige tu Hospedaje
            ...
            <p className="text-[#2b3a32] max-w-lg mx-auto mt-4 text-sm font-medium">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-start">
            {/* Card 1: Camping */}
            <div className="bg-white rounded-2xl p-8 border border-emerald-100 shadow-md flex flex-col text-center relative">
              <span className="text-xs uppercase tracking-widest text-[#ea580c] font-bold mb-2">Rústico y Cercano</span>
              <h3 className="text-2xl font-display font-bold text-emerald-950 mb-2">Camping</h3>
              ...
              <a 
                ...
                target="_blank" 
                rel="noopener noreferrer" 
                className="w-full py-3.5 bg-emerald-600 hover:bg-emerald-700 text-white rounded-full font-display font-bold shadow-md shadow-emerald-600/10 transition block mb-4"
              >
                Reservar Camping
              </a>
            ...
            <div className="bg-white rounded-2xl p-8 border border-emerald-100 shadow-md flex flex-col text-center relative">
              ...
              <h3 className="text-2xl font-display font-bold text-emerald-950 mb-2">Refugio</h3>
              <p className="text-sm text-slate-600 min-h-[50px] mb-6 font-medium">
            ...
            <div className="bg-white rounded-2xl p-8 border-2 border-emerald-500 flex flex-col text-center relative shadow-2xl transform md:scale-105">
              <div className="absolute -top-3.5 left-1/2 -translate-x-1/2 bg-emerald-600 text-white px-4 py-0.5 rounded-full text-xs font-display font-bold uppercase tracking-wider">
                Recomendada
              </div>
              <span className="text-xs uppercase tracking-widest text-[#ea580c] font-bold mb-2">Máximo Confort</span>
              <h3 className="text-2xl font-display font-bold text-emerald-950 mb-2">Cabaña</h3>
              <p className="text-sm text-slate-600 min-h-[50px] mb-6 font-medium">
              ...
              <span className="text-[10px] text-emerald-700 bg-emerald-100 py-1 px-3.5 rounded inline-block self-center">
                Valor referencial no confirmado
              </span>
            </div>
          </div>
      ...
      <footer id="contacto" className="bg-[#121c17] text-white pt-20 pb-10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="border-t border-emerald-900/60 pt-8 text-center text-xs text-emerald-200/50">
